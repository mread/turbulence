...
public abstract class CommonProcessor {
    ...
    public abstract List<AuthorValue> process(List<CommitParentAuthorTimestamp> commits);
    ...
    protected int calculateNetChurn(CommitParentAuthorTimestamp commitParentAuthorTimestamp, List<String> modifiedFiles) {
        List<String> commitChurn = getGitAdapter().getCommitChurn(getTargetDirectory(), commitParentAuthorTimestamp.getCommit());
    ...
    protected int calculateNetComplexityDelta(CommitParentAuthorTimestamp commitDetails, List<String> files) {
